...
$dbpass = '98xf7xW8S5pkhLuR';		
	...
	$query = "SELECT M.mName, A.soberBrother, A.guestName FROM final_attendence A, final_membership M WHERE M.sID = A.sID AND M.partyName = '$pName' AND M.partyDate = '$pDate';";
